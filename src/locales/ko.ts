export default {
  translation: {
    ...
    // SEO Content - Intro
    "seo.intro.title":
      "K-Pop 아이돌 사진을 위한 최고의 AI 고화질 변환기 (MyBias)",
    "seo.intro.description1":
      "MyBias는 흐릿하고 노이즈가 심한 아이돌 사진을 최신 인공지능(AI) 기술을 사용하여 선명한 고해상도(HD, 4K) 이미지로 복원해 주는 무료 온라인 도구입니다. 콘서트장, 팬미팅, 혹은 저화질 방송 캡처 화면 속의 '최애(Bias)' 얼굴이 뭉개져 보여 속상하셨나요?",
    "seo.intro.description2":
      "우리의 독자적인 AI 엔진은 단순히 이미지 크기만 늘리는 것이 아닙니다. CodeFormer 및 Real-ESRGAN 알고리즘을 기반으로 흐릿한 이목구비를 분석하고, 손실된 디테일을 추론하여 마치 원본이 고화질이었던 것처럼 자연스럽게 복원합니다. 트위터, 인스타그램에 공유하기 딱 좋은 최고의 퀄리티를 지금 경험해 보세요.",

    // SEO Content - How-to
    "seo.howto.title": "3단계로 끝나는 고화질 변환 방법",
    "seo.howto.step1.title": "이미지 업로드",
    "seo.howto.step1.description":
      "'파일 선택' 버튼을 클릭하여 갤러리에 있는 저화질 아이돌 사진을 업로드하세요. JPG, PNG, WEBP 등 대부분의 이미지 포맷을 지원합니다. (최대 5MB)",
    "seo.howto.step2.title": "AI 모델 처리",
    "seo.howto.step2.description":
      "업로드와 동시에 클라우드 GPU 서버에서 AI 모델이 작동합니다. 얼굴 복원(Face Restoration)과 해상도 업스케일링(Upscaling) 작업이 동시에 진행되며, 이 과정은 사진의 복잡도에 따라 약 10초에서 30초 정도 소요될 수 있습니다.",
    "seo.howto.step3.title": "비교 및 다운로드",
    "seo.howto.step3.description":
      "변환이 완료되면 원본과 결과물을 슬라이더로 직접 비교해 보세요. 마음에 든다면 다운로드 버튼을 눌러 소장하거나, 소셜 미디어에 바로 공유할 수 있습니다.",

    // SEO Content - Features
    "seo.features.title": "왜 MyBias를 사용해야 할까요?",
    "seo.features.ai.title": "얼굴 복원에 특화된 AI",
    "seo.features.ai.description":
      "일반적인 풍경 업스케일러와 달리, 사람의 이목구비 복원에 특화된 딥러닝 모델을 사용하여 눈동자, 속눈썹, 입술 질감을 생생하게 살려냅니다.",
    "seo.features.privacy.title": "안전한 사진 보관",
    "seo.features.privacy.description":
      "회원가입 후 AI 변환한 이미지는 '내 사진함'에 안전하게 저장되어 언제든지 다시 확인하고 다운로드할 수 있습니다. 소중한 추억을 잃어버릴 걱정 없이 안심하고 사용하세요.",
    "seo.features.mobile.title": "모바일 최적화",
    "seo.features.mobile.description":
      "별도의 앱 설치 없이 아이폰, 갤럭시 등 모바일 브라우저에서도 PC와 동일한 고성능 AI 기능을 사용할 수 있습니다.",
    ...
    "terms.updateDate": "2024년 12월 22일",
    "terms.section1.title": "1. 서비스 소개",
    "terms.section1.content":
      "MyBias(이하 '서비스')는 인공지능(AI) 기술을 활용하여 사용자가 업로드한 이미지의 화질을 개선하는 무료 온라인 도구입니다. 본 서비스를 이용함으로써 귀하는 본 이용약관에 동의하는 것으로 간주됩니다.",
    "terms.section2.title": "2. 서비스 이용 조건",
    ...
    "privacy.section7.content":
      "개인정보 처리에 관한 문의 사항이 있으시면 mybias.official@gmail.com으로 연락해 주시기 바랍니다.",
  },
};
