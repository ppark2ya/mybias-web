export default {
  translation: {
    ...
    "editor.proRestore.enhancingSkinTone": "피부 톤을 완벽하게 보정하고 있어요...",
    "editor.proRestore.optimizingColors": "색감을 최적화하고 있어요...",
    "editor.proRestore.upscaling": "고해상도로 업스케일 중...",
    "editor.proRestore.almostDone": "거의 다 됐어요!",
    "editor.proRestore.downloadingImage": "이미지 다운로드 중...",
    ...
    "editor.proRestore.preview.subtitle": "2배 업스케일링과 고급 AI 복원",
    "editor.proRestore.preview.before": "복원 전",
    "editor.proRestore.preview.after": "복원 후 (예상)",
    "editor.proRestore.preview.info": "Pro 복원은 프롬프트 엔지니어링을 적용한 고급 AI로 최상의 결과를 제공합니다. 2배 업스케일링, 자연스러운 피부 톤 보정, 전문가급 색보정이 포함됩니다.",
    "editor.proRestore.preview.denoising": "복원 강도",
    "editor.proRestore.preview.denoisingLow": "약하게",
    "editor.proRestore.preview.denoisingHigh": "강하게",
    ...
    "editor.proRestore.result.info": "Pro AI가 디테일을 복원하고, 피부 톤을 보정하고, 색감을 최적화하고, 2배 해상도로 업스케일했습니다. 되돌리기로 원본으로 복원할 수 있습니다.",
    "editor.proRestore.result.confirm": "확인",
    "editor.proRestore.features.upscale2x": "2배 업스케일",
    "editor.proRestore.features.skinTone": "자연스러운 피부 톤",
    "editor.proRestore.features.colorCorrection": "색보정",
    "editor.proRestore.features.promptGuided": "프롬프트 기반 AI",
