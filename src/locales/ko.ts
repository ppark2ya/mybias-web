export default {
  translation: {
    ...
    "login.signupButton": "회원가입",
    "login.sendMagicLink": "로그인 링크 받기",
    ...
    "login.signupEmailSent": "인증 이메일을 전송했습니다!",
    "login.checkEmail": "이메일을 확인해주세요",
    "login.emailSentDescription": "{{email}}로 로그인 링크를 보냈습니다. 이메일을 확인하고 링크를 클릭해주세요.",
    "login.signupEmailSentDescription": "{{email}}로 인증 이메일을 보냈습니다. 이메일을 확인하고 링크를 클릭하여 회원가입을 완료해주세요.",
