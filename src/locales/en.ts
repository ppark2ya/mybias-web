export default {
  translation: {
    ...
    "lookbook.accessoryNotice": "Photos with facial accessories like glasses or sunglasses may show differences from your original face due to the AI face restoration process.",
    ...
    "login.continueWithEmail": "Continue with Email Link",
    "login.continueWithPassword": "Continue with Email/Password",
    "login.or": "or",
    ...
    "login.emailAlreadyExists": "This email is already registered",
    "login.invalidCredentials": "Invalid email or password",
    "login.signUpSuccess": "Sign up successful! Please check your email.",
    ...
    "login.signUpEmailSentDescription":
      "We sent a verification email to {{email}}. Please check your inbox and click the link to complete sign up.",
    ...
    "login.continueWithUsername": "Continue with Username",
    "login.continueWithMagicLink": "Continue with Magic Link",
    "login.usernameLabel": "Username",
    "login.usernamePlaceholder": "Enter your username",
    "login.enterUsername": "Please enter your username",
    "login.usernameInvalid": "Username can only contain letters, numbers, and underscores",
    "login.usernameTooShort": "Username must be at least 3 characters",
    "login.usernameTooLong": "Username must be no more than 20 characters",
