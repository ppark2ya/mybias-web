export default {
  translation: {
    ...
    "login.signupEmailSent": "Verification email sent!",
    ...
    "login.signupEmailSentDescription":
      "We sent a verification email to {{email}}. Please check your inbox and click the link to complete your registration.",
