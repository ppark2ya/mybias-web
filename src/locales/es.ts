export default {
  translation: {
    ...
    "login.emailSent": "¡Enlace de inicio de sesión enviado a tu correo!",
    "login.checkEmail": "Revisa tu correo",
    "login.emailSentDescription": "Enviamos un enlace de inicio de sesión a {{email}}. Por favor revisa tu bandeja de entrada y haz clic en el enlace.",
    "login.tryAnotherMethod": "Probar otro método",
