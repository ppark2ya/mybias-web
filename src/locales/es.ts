export default {
  translation: {
    ...
    "login.loginWithEmail": "Iniciar sesión con Email",
    ...
    "login.signupEmailSent": "¡Email de verificación enviado!",
    ...
    "login.signupEmailSentDescription": "Enviamos un email de verificación a {{email}}. Por favor revisa tu bandeja de entrada y haz clic en el enlace para completar tu registro.",
