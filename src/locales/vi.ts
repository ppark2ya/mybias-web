export default {
  translation: {
    ...
    "login.confirmPasswordLabel": "Xác Nhận Mật Khẩu",
    "login.confirmPasswordPlaceholder": "Nhập lại mật khẩu",
    "login.continue": "Tiếp Tục",
    "login.sending": "Đang gửi...",
    "login.loggingIn": "Đang đăng nhập...",
    "login.signingUp": "Đang đăng ký...",
    "login.loginButton": "Đăng Nhập",
    "login.signupButton": "Đăng Ký",
    "login.sendMagicLink": "Gửi Liên Kết Đăng Nhập",
    ...
    "login.signupEmailSent": "Đã gửi email xác nhận!",
    ...
    "login.signupEmailSentDescription": "Chúng tôi đã gửi email xác nhận đến {{email}}. Vui lòng kiểm tra hộp thư đến và nhấp vào liên kết để hoàn tất đăng ký.",
