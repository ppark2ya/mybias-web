export default {
  translation: {
    ...
    "uploader.dragActive": "Thả vào đây",
    "uploader.dragInactive": "Kéo hoặc nhấp để thêm ảnh",
    "uploader.button": "Thêm Ảnh",
    ...
    "editor.close": "Đóng",
    "editor.lockAspectRatio": "Khóa tỷ lệ",
    "editor.unlockAspectRatio": "Mở khóa tỷ lệ",
    ...
    "editor.ai.enhancingSkinTone": "Đang cải thiện tông da...",
    "editor.ai.sharpeningEyes": "Đang làm sắc nét mắt...",
    "editor.ai.enhancingDetails": "Đang cải thiện chi tiết...",
    "editor.ai.almostDone": "Sắp xong rồi!",
    "editor.ai.downloadingImage": "Đang tải xuống hình ảnh...",
    "editor.ai.failed": "Cải thiện AI thất bại. Vui lòng thử lại.",
    "editor.ai.timeout": "Phản hồi máy chủ AI bị chậm. Vui lòng thử lại sau.",

    // Editor - AI Preview Modal
    "editor.ai.preview.title": "Cải Thiện AI",
    ...
    "editor.ai.preview.fidelity": "Độ trung thực",
    "editor.ai.preview.fidelityLow": "Khôi phục tốt hơn",
    "editor.ai.preview.fidelityHigh": "Giữ đặc điểm gốc",

    // Editor - AI Result Modal
    "editor.ai.result.title": "Cải Thiện Hoàn Tất",
    ...
    "editor.eraser.analyzingArea": "Đang phân tích vùng được chọn...",
    "editor.eraser.removingObject": "Đang xóa đối tượng...",
    "editor.eraser.fillingBackground": "Đang điền nền...",
    ...
    "gallery.subtitle": "Ảnh được cải thiện bằng AI",
    "gallery.backToHome": "Trang Chủ",
    "gallery.loading": "Đang tải ảnh...",
    "gallery.loadError": "Tải ảnh thất bại.",
    "gallery.empty": "Chưa có ảnh được cải thiện",
    "gallery.emptyHint": "Hãy thử tính năng cải thiện AI",
    "gallery.startCreating": "Bắt Đầu Tạo",
    "gallery.download": "Tải Xuống",
    "gallery.downloading": "Đang tải xuống...",
    "gallery.close": "Đóng",

    // Profile
    "profile.title": "Hồ Sơ Của Tôi",
    "profile.backToHome": "Trang Chủ",
    "profile.email": "Email",
    "profile.memberSince": "Thành Viên Từ",
    "profile.aiCredits": "Điểm AI",
    "profile.creditsRemaining": "Còn {{count}} lượt",
    "profile.charge": "Nạp Điểm",
    ...
    "login.back": "Quay Lại",
    "login.backToHome": "Quay Về Trang Chủ",
    "login.enterEmail": "Vui lòng nhập email của bạn",
    ...
    // Legal Pages Common
    "legal.backToHome": "Quay Về Trang Chủ",
